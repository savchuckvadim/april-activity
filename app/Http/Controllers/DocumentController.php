...
class DocumentController extends Controller
{
...

    {
        ...
        //Main
$letterText = '
В честь 30-летия компании мы предоставляем уникальную возможность воспользоваться передовыми технологиями в работе с правовой информацией по доступной цене. \r\nС системой ГАРАНТ Вы сможете: \r\n\r\n<color>Решить любую задачу с полной информационной и правовой поддержкой:</color> нормативные акты федерального и регионального уровня; профессиональная аналитика; практические рекомендации; более 120 000 готовых экспертных заключений; библиотеки, судебная практика, профессиональные СМИ.  \r\n<color>Получать индивидуальные заключения по Вашим вопросам от экспертов федерального уровня! </color>\r\n\r\n<color>Пользоваться качественным сервисным обслуживанием:</color>  возможность обращаться на Горячую линию правовой поддержки, обучение работе с системой, техническая поддержка. \r\n<color>Работать только с актуальной правовой информацией:</color>  комплект обновляется 3 раза в день! \r\n<color>Всегда иметь под рукой наиболее полную базу: </color> Вам доступны более 150 000 000 документов.  \r\n\r\n<color>Существенно экономить время на изучении изменений в законодательстве получая последние правовые изменения только по интересующим Вас профессиональным сферам!  \r\n<color>Все самое важное и необходимое для работы будет всегда под рукой! Благодаря 9 настраиваемым профессиональным страницам, каждый специалист Вашей организации сможет быстро ориентироваться в правовом поле, легко работать с большим объемом информации.  \r\n\r\n<color>Работать с системой при первой необходимости:</color> в любое время и в любом месте – на работе, в командировке, на заседании суда, дома.  \r\n<color>Получить полную информацию о контрагенте, а также защитить свои активы</color> с помощью сервисов «Экспресс Проверка» и «Бизнес на контроле». \r\n \r\n<color>Быстро и правильно</color> создать учетную политику организации, подготовить договор или доверенность, написать претензию или исковое заявление с конструктором учетной политики и правовых документов.  \r\n<color>Организовать профессиональное обучение!</color> Повышайте свою квалификацию и узнавайте мнение экспертов по актуальным правовым вопросам и изменениям в законодательстве.  \r\n<color>Оптимизировать свои расходы на информационно-правовое обеспечение</color> благодаря нашей гибкой ценовой политике и специальным условиям!"
';
